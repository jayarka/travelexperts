...
<head>
  ...
  <link rel="stylesheet"  href="european.css">
  <script src="european.js"></script>
...
<div class="page">
  <!-- this is the image that would introduce the page. 
    ...
    <img class="main" src="european16.jpg"> 
      ...
      <div class="destination-info-box">
        ...
        <!-- this part is for the rating stars. i created class to costumes the stars, like coloring the stars  -->
          ...
          when you are using icons make sure the website that suports icons to be linked in to you page. -->
                ...
                <br>
                <br>
                <i class='fas fa-plane-arrival'></i><span>London International Airport, UK</span>
                <br>
                <br>
                <i class='fas fa-train'></i><span>London, Amsterdam, Venice, Roma, Barcelona</span>
                <br>
                <br>
          ...
          <button type="submit" name="4" class="button">Book</button>
           </form>
           <div class="counter">
            <i class="fa fa-eye"></i>
            ...
            <?php
             // Create a variable //
                $hits = file("counter4.txt");
                //Add one to the file //
                $hits[0] ++;
                //Open the file and write on file//
                $fp = fopen("counter4.txt", "w");
...
<div id="photos" class="tabcontent" >
         ...
         <img src="european2.jpg" alt="european" class="img">
         <img src="european3.jpg" alt="european" class="img">
         <img src="european4.jpg" alt="european" class="img">
         <img src="european5.jpg" alt="european" class="img">
         <img src="european6.jpg" alt="european" class="img">
         <img src="european7.jpg" alt="european" class="img">
         <img src="european8.jpg" alt="european" class="img">
         <img src="european9.jpg" alt="european" class="img">
         <img src="european10.jpg" alt="european" class="img">
         <img src="european11.jpg" alt="european" class="img">
         <img src="european12.jpg" alt="european" class="img">
         <img src="european13.jpg" alt="european" class="img">
...
<div id="ITINERARY DETAILS" class="tabcontent">
  ...
  <h5>PLACES VISITED</h5>
      ...
      <br>
      <img src="european15.jpg" alt="european" class="img" style="center">
      <br>
      <br>
