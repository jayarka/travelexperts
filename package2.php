...
<head>
  ...
  <link rel="stylesheet"  href="polynesian.css">
  <script src="polynesian.js"></script>
...
<div class="page">
  <!-- this is the image that would introduce the page. 
    create a class for the image in order to costumes image. -->
     <img class="main" src="polynesian16.jpg">
      ...
      <div class="destination-info-box">
        ...
        <!-- this part is for the rating stars. i created class to costumes the stars, like coloring the stars  -->
          ...
          when you are using icons make sure the website that suports icons to be linked in to you page. -->
                ...
                <br>
                <br>
                <i class='fas fa-plane-arrival'></i><span>Bora Bora Airport</span>
                <br>
                <br>
          ...
          <button type="submit" name="2" class="button">Book</button>
           </form>
           <div class="counter">
            <i class="fa fa-eye"></i>
...
<div id="photos" class="tabcontent" >
         ...
         <img src="polynesian2.jpg" alt="Bora Bora" class="img">
         <img src="polynesian3.jpg" alt="Bora Bora" class="img">
         <img src="polynesian4.jpg" alt="Bora Bora" class="img">
         <img src="polynesian5.jpg" alt="Bora Bora" class="img">
         <img src="polynesian6.jpg" alt="Bora Bora" class="img">
         <img src="polynesian7.jpg" alt="Bora Bora" class="img">
         <img src="polynesian8.jpg" alt="Bora Bora" class="img">
         <img src="polynesian9.jpg" alt="Bora Bora" class="img">
         <img src="polynesian10.jpg" alt="Bora Bora" class="img">
         <img src="polynesian11.jpg" alt="Bora Bora" class="img">
         <img src="polynesian12.jpg" alt="Bora Bora" class="img">
         <img src="polynesian13.jpg" alt="Bora Bora" class="img">
...
<h5>PLACES VISITED</h5>
      ...
      <br>
      <img src="polynesian15.jpg" alt="european" class="img" style="center">
      <br>
      <br>
