        ...
        <h2>Asian Expedition</h2>
         <!-- this part is for the rating stars. i created class to costumes the stars, like coloring the stars  -->
          ...
          when you are using icons make sure the website that suports icons to be linked in to you page. -->
                ...
                <br>
                <br>
                <i class='fas fa-plane-arrival'></i><span>Gusti Ngurah Rai International Airport Bali, indonisia</span>
                <br>
                <br>
          ...
          <button type="submit" name="3" class="button">Book</button>
           </form>
           <div class="counter">
            <i class="fa fa-eye"></i>
            ...
            <?php
             // Create a variable //
                $hits = file("counter3.txt");
                //Add one to the file //
                $hits[0] ++;
                 //Open the file and write on file//
                $fp = fopen("counter3.txt", "w");
...
the tab uses javascript functions therefore i commented on the javascript page about the function use-->
        ...
        <div id="photos" class="tabcontent" >
            <img src="asia5.jpg" alt="Bali" class="img">
            <img src="asia8.jpg" alt="Bali" class="img">
            <img src="asia1.jpg" alt="Bali" class="img">
            <img src="asia11.jpg" alt="Bali" class="img">
            <img src="asia2.jpg" alt="Bali" class="img">
            <img src="asia6.jpg" alt="Asia" class="img"> 
            <img src="asia10.jpg" alt="Asia" class="img"> 
            <img src="asia7.jpg" alt="Asia" class="img"> 
            <img src="asia4.jpg" alt="Asia" class="img"> 
            <img src="asia13.jpg" alt="Bali" class="img">
            <img src="asia12.jpg" alt="Bali" class="img">
            <img src="asia9.jpg" alt="Bali" class="img">
        </div>
      ...
      <div id="ITINERARY DETAILS" class="tabcontent">
            ...
            <h5>PLACES VISITED</h5>
                ...
                <br>
                <img src="asia15.jpg" alt="Bali" class="img" style="center">
                <br>
                <br>
