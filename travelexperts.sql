...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 16, 2019 at 06:11 AM
...
INSERT INTO `creditcards` (`CreditCardId`, `CCName`, `CCNumber`, `expmonth`, `expyear`, `cvv`, `CustomerId`) VALUES
(2, 'AMEX', '12342324248393', '2019-04-03', '', '', 123),
(26, 'AMEX', '33454212345651', '2019-09-29', '', '', 127),
(28, 'AMEX', '3422343212433430', '2019-07-19', '', '', 107),
(30, 'AMEX', '34458998784345', '2019-08-22', '', '', 140),
(31, 'AMEX', '345433789979389', '2019-11-05', '', '', 130),
(41, 'AMEX', '3522354387984530', '2019-06-09', '', '', 106),
(63, 'AMEX', '632456487984533', '2019-01-02', '', '', 142),
(69, 'AMEX', '78789007977999', '2019-08-22', '', '', 104),
(91, 'AMEX', '904883289756439', '2019-01-19', '', '', 133),
(99, 'Diners', '12093458976902', '2019-11-02', '', '', 143),
(123, 'Diners', '24348343482482', '2020-11-25', '', '', 109),
(141, 'Diners', '3749234924723790', '2019-05-01', '', '', 128),
(163, 'Diners', '6788922940392940', '2019-10-12', '', '', 139),
(167, 'Diners', '699834387984533', '2019-01-04', '', '', 118),
(169, 'Diners', '7482794729742320', '2019-04-12', '', '', 117),
(185, 'Diners', '8901128935238970', '2019-10-20', '', '', 141),
(201, 'MC', '3424345432894320', '2019-01-22', '', '', 120),
(230, 'VISA', '12122387984533', '2019-12-13', '', '', 121),
(239, 'VISA', '2311240543980120', '2019-11-03', '', '', 114),
...
(280, '', '', '', '', '', 145),
(281, 'sasad', '1234', '10', '2019', '333', 146);
...
(145, 'ytghyth', 'cc', '44545', 'é¢åº¦', '12', '2334', '', '211221', '211221', 'xzzxcxcc@dfsad.fgh', NULL),
(146, 'ytghyth', 'cc', '44545', 'é¢åº¦', '12', '2334', '', '211221', '211221', 'xzzxcxcc@dfsad.fgh', NULL),
(147, 'Asdfs', 'Asdfs', 'asdfads', 'Edadf', 'AB', 't6t6t6', 'Canada', '(123)123-1234', '(123)123-1234', 'aef@sdaf.com', NULL);
...
CREATE TABLE `customer_login` (
  ...
  `Class` varchar(2) NOT NULL DEFAULT 'C',
  `CustomerId` int(11) DEFAULT NULL,
  `AgentId` int(11) DEFAULT NULL,
...
INSERT INTO `customer_login` (`Id`, `UserId`, `Password`, `Class`, `CustomerId`, `AgentId`, `reg_date`) VALUES
(1, 'asdfas', '$2y$10$7CznBKsa3AUB4hzEVhgyZe6z1sfAtC7Ie8Nc0Ld5yRblMQqNSY9Fe', 'C', 147, NULL, '2019-04-15 22:58:33');
...
CREATE TABLE `packages` (
  ...
  `PkgStartDate` varchar(20) DEFAULT NULL,
  `PkgEndDate` varchar(20) DEFAULT NULL,
  `PkgDesc` varchar(50) DEFAULT NULL,
  `PkgBasePrice` decimal(19,0) NOT NULL,
  `PkgAgencyCommission` decimal(19,0) DEFAULT NULL,
  `photos` varchar(50) NOT NULL,
  `Description` text NOT NULL,
  `ItineraryDetails` text NOT NULL,
...
INSERT INTO `packages` (`PackageId`, `PkgName`, `PkgStartDate`, `PkgEndDate`, `PkgDesc`, `PkgBasePrice`, `PkgAgencyCommission`, `photos`, `Description`, `ItineraryDetails`, `page1`, `pic1`, `pic2`, `pic3`, `Views`) VALUES
(1, 'Caribbean New Year', 'Dec 26/ 2019', 'Jan 03/ 2020', 'Cruise the Caribbean & Celebrate the New Year.', '4800', '400', '\'caribbean0.jpg\'', '', '', '', '\'Caribbean1.jpg\'', '\'Caribbean2.jpg\'', '\'Caribbean3.jpg\'', 'counter1.txt'),
(2, 'Polynesian Paradise', 'Sept 11/ 2019', 'Sept 19/2019', 'Tahiti Vacation Package for Two: 7 Days of Romance', '3000', '310', '\'polynesian0.jpg\'', '', '', '', '\'hawaii1.jpg\'', '\'hawaii2.jpg\'', '\'hawaii3.jpg\'', 'counter2.txt'),
(3, 'Asian Expedition', 'Nov 18/ 2019', 'Nov 26/2019', 'Airfaire, Hotel and Eco Tour.', '2800', '300', '\'asia0.jpg\'', '', '', '\'asia.html\'', '\'asia1.jpg\'', '\'asia2.jpg\'', '\'asia3.jpg\'', 'counter3.txt'),
(4, 'European Vacation', 'Jun 02/ 2019', 'Jun 10/ 2019', 'Euro Tour with Rail Pass and Travel Insurance', '3000', '280', '\'european0.jpg\'', '', '', '', '\'European1.jpg\'', '\'European2.jpg\'', '\'European3.jpg\'', 'counter4.txt');
...
--
ALTER TABLE `creditcards`
  MODIFY `CreditCardId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=282;
...
--
ALTER TABLE `customer_login`
  ADD CONSTRAINT `customer_login_ibfk_1` FOREIGN KEY (`CustomerId`) REFERENCES `customers` (`CustomerId`),
  ADD CONSTRAINT `customer_login_ibfk_2` FOREIGN KEY (`AgentId`) REFERENCES `agents` (`AgentId`);
